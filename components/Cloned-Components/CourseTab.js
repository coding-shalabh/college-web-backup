...
const CourseTab = ({ course, start, end, pageType = 1 }) => {
  ...
  return (
    <>
      ...
      >
        {pageType == 1 ? course?.slice(start, end)?.map((data, index) => (
          <Link href={pageType == 1 ? `/colleges/${data._id.$oid}` : pageType == 2 ? `/college-details/${data._id.$oid}` : '#'} className="course-grid-3" key={index}>
            <div
            ...
            >
              ...
              <div className="rbt-card-body">
                ...
                <p className="rbt-card-text" dangerouslySetInnerHTML={{ __html: data.description }}></p>
            ...
            <Link href={pageType == 1 ? `/colleges/${data._id.$oid}` : pageType == 2 ? `/college-details/${data._id.$oid}` : '#'} className="course-grid-3" key={index}>
              ...
              >
                ...
                <div className="rbt-card-body">
                  ...
                  <p className="rbt-card-text" dangerouslySetInnerHTML={{ __html: data.excerpt }}></p>
                  {/* <div className="rbt-author-meta mb--10">
                  <div className="rbt-avater">
                  <Link href="#">
                  <Image
