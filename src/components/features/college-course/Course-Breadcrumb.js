    ...
    <>
      <div className="col-lg-8">
        <div className="content text-start">
          ...
          {/* <p className="description">{getMatchCourse?.about}</p> */}
          ...
          <div className="d-flex align-items-center mb--20 flex-wrap rbt-course-details-feature">
            ...
            <div className="feature-sin rating">
              {/* <Link href="#">{getMatchCourse?.reviews}</Link> */}
              {Array.apply(null, Array(parseInt(getMatchCourse?.reviews) || 0))?.map((_, index) => {
                return (
                  <Link key={index} href="#">
